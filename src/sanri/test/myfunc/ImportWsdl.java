...
//		List<Operation> operationList = wsdl.getOperations();
...
//	}
//
//	public void getParameter(Element element2, int gen, int genParent, List<String> inputType, List<String> inputNames, List<String> isparent) {
//		if (element2 != null) {
