...
//    	String ip = "192.168.124.132";
//    	int port = 22;
//    	String user ="root";
//    	String password = "h196944";
//    	String cmd[] = {"ls","ifconfig"};
...
//            }
//            //防止最后一个命令执行不了
//            int expect2 = expect.expect(lstPattern);
//            isSuccess = !(expect2 == COMMAND_EXECUTION_SUCCESS_OPCODE);
//
//            //找不到错误信息标示成功
...
//        try {
//        	int expect2 = expect.expect(objPattern);
//            boolean isFailed = (expect2 == COMMAND_EXECUTION_SUCCESS_OPCODE);
//            if (!isFailed) {
