...
public class HelloServiceImpl implements HelloService{
	...
	@WebMethod
	@Override
	public void batchQuery(@WebParam(name="simpleStudents") List<SimpleStudent> simpleStudents) {
		for (SimpleStudent simpleStudent : simpleStudents) {
			System.out.println(JSONObject.toJSONString(simpleStudent));
		}
	}
