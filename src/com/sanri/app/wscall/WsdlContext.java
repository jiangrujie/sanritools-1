...
//	private final static String [] BASE_TYPES = {"string","decimal","integer","int","float","long","boolean","time","date","datetime","array","anyType"};
	...
	static{
		...
		try {
			...
			File soap11File = new File(pkgPath+"/soap11.xml");
			File soap12File = new File(pkgPath+"/soap12.xml");
			BASE_SOAP11_DOCUMENT = FileUtils.readFileToString(soap11File);
			BASE_SOAP12_DOCUMENT = FileUtils.readFileToString(soap12File);
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
